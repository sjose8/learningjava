...
import com.bitbucket.learningjava.TaxCalculator;
...
public class TaxCalculatorTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                ...
                {false, 20450, 3067.50 }, {false, 35800, 5370.00}, {false, 50000, 14000.00}, {false, 86500, 24220}, {false, 90000, 27900}
        });
    }
    ...
    public void test() {
        ...
        assertThat(tax).isEqualTo(this.tax, offset(0.1));
    }
